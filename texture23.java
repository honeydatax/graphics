...
public class texture23 extends Applet {
	int ii=4;
	int x=50;
	int y=50;
	int px=0;
	...
	public void init(){
		...
		for (n=0;n<250;n=n+20){
			gg1.drawLine(0,n,580,n);
		}
		for (n=1;n<580;n=n+n){
			gg1.drawLine(n,0,n,250);
		}
	...
	public void paint (Graphics g) {
		...
		for (bn=0;bn<630/2;bn++){
				bnn=bn;
				gg.drawImage(bitmap2,(630/2)-bn,150-bnn,((630/2)-bn)+1,150+bnn,bn,0,bn+1,300,null);
				gg.drawImage(bitmap2,(630/2)+bn,150-bnn,((630/2)+bn)+1,150+bnn,bn,0,bn+1,300,null);
			}
