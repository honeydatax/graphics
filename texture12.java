...
public class texture12 extends Applet {
	int ii=4;
	int x=50;
	int y=50;
	int px=0;
	...
	public void init(){
		...
		gg2.setColor(c);
		for (n=0;n<550;n++){
				n1=(int) Math.round(Math.random()*910.00);
				nn=(int) Math.round(Math.random()*280.00);
				nnn=(int) Math.round(Math.random()*30.00);
				gg2.fillOval(n1,nn,nnn,nnn);
		}
